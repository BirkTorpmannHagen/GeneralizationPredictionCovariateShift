...
def run_acc_prediction_experiments():
    ...
    dr_gap_correlation_distribution(1)
    threshold_method_comparison(1)
    paired, stats = method_statistical_tests(batch_size=1)

    pivot, corrected_rows = accuracy_prediction_table(batch_size=1)
